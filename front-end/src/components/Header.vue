      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="boardsMenu">
          ...
          <div v-show="hasBoards">
            <h6 class="dropdown-header" v-show="myBoards.length">Personal Boards</h6>
            <button v-for="board in myBoards" v-bind:key="board.id" @click="openBoard(board)"
    ...
    <div class="profile-menu-toggle">
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="profileMenu">
          <button class="dropdown-item" type="button">프로필</button>
          <button class="dropdown-item" type="button" @click="signOut()">로그아웃</button>
        </div>
      </div>
    </div>
  </div>
