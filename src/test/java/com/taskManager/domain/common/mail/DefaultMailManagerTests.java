...
public class DefaultMailManagerTests {
    ...
    public void setUp() {
      ...
      instance = new DefaultMailManager("weotjqw@naver.com", mailerMock, configuration);
    }
    ...
    public void send_nullSubject_shouldFail() {
      instance.send("weotjqw@gmail.com", null, "test.ftl");
    }
  
    @Test(expected = IllegalArgumentException.class)
    public void send_emptySubject_shouldFail() {
      instance.send("weotjqw@gmail.com", "", "test.ftl");
    }
  
    @Test(expected = IllegalArgumentException.class)
    public void send_nullTemplateName_shouldFail() {
      instance.send("weotjqw@gmail.com", "Test subject", null);
    }
  
    @Test(expected = IllegalArgumentException.class)
    public void send_emptyTemplateName_shouldFail() {
      instance.send("weotjqw@gmail.com", "Test subject", "");
    }
    ...
    public void send_validParameters_shouldSucceed() {
      ...
      instance.send(to, subject, templateName, MessageVariable.from("name", "user"));
      ...
      assertEquals("weotjqw@naver.com", messageSent.getFrom());
      // assertEquals("Hello, user", messageSent.getBody());
    }
}